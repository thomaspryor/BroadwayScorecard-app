 ...
 *
 * 18pt, not the web's 14px: the diary grid is 3-up and the star row sits under
 * a ~130pt poster, so 14pt read as a thin smudge — "the stars are too small,
 * there's width available" (beta feedback 2026-08-03, AIx0mAT5). Five 18pt
 * stars plus gaps come to ~94pt, comfortably inside the cell.
 */
